import pandas as pd
data=pd.read_excel(r'C:\Users\28374\Desktop\Data\Day2.xlsx').drop('NO.',axis=1)    #path of the document may need to be modified
...
dtc=DecisionTreeClassifier(random_state=420,criterion='gini',max_depth=3,min_samples_split=3,splitter='random').fit(X_train,y_train)
