import pandas as pd
data=pd.read_excel(r'C:\Users\28374\Desktop\Data\Day1.xlsx').drop('NO.',axis=1)
...
print('alpha output',ls_.alpha_)     #alpha=0.04923204774372986
LASSO=Lasso(alpha=0.04923204774372986).fit(X_train,y_train)
